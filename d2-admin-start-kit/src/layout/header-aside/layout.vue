<template>
  <div class="d2-layout-header-aside-group testbg" :style="styleLayoutMainGroup" :class="{grayMode: grayActive}">
    <!-- 半透明遮罩 -->
    <div class="d2-layout-header-aside-mask"></div>
    <!-- 主体内容 -->

    <d2-container type="card" style="    position: fixed;
    left: 540px;
    color: white;
    width: 36%;
    height: 8%;
    ...
    margin: 0;
    padding-left: 20px;
    padding-top: 10px;">安徽省县域农村精准扶贫空间分析系统</h1>
    </d2-container>
